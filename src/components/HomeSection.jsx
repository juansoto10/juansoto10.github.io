...
const HomeSection = () => {
  return (
    <section className="flex flex-col justify-center items-start sm:min-h-layout lg:px-16 xl:px-32 2xl:px-48 3xl:px-80 pt-12 sm:pt-4 2xl:pt-0 mt-[100px] mb-24 2xl:mb-0">
      ...
      <div>
        <h2 className="text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl font-bold tracking-wide mb-3 sm:mb-4 md:mb-5">
          Juan Soto.
        </h2>
      </div>
      <div>
        <h3 className="text-4xl sm:text-5xl lg:text-6xl 2xl:text-7xl text-indigo-200 leading-9 sm:leading-[3.2rem] lg:leading-[4.6rem] font-bold tracking-wide mb-6 sm:mb-8 md:mb-10">
